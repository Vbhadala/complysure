CHECKLIST_ITEMS = [
    ...
    {"sr_no": 21, "parameter": "Call recordings and client order instructions are maintained and readily available.", "remark": "yes"},
    ...
    {"sr_no": 28, "parameter": "Social media accounts and bank statements reviewed; no guaranteed returns are promised to clients.", "remark": "yes"},
    {"sr_no": 29, "parameter": "All mandatory documents (contract notes, fund statements, daily margin statements) are generated and issued to clients by the AP.", "remark": "yes"},
    {"sr_no": 30, "parameter": "No location change of AP/Branch has occurred; if changed, clients were notified at least 30 days in advance.", "remark": "yes"},
    {"sr_no": 31, "parameter": "Any change in AP/Branch contact details (address, email, mobile) has been correctly reported and updated with the exchange.", "remark": "yes"},
    ...
    {"sr_no": 39, "parameter": "No other observations indicating potential non-compliance have been found.", "remark": "yes"},
    {"sr_no": 40, "parameter": "Any Other Observation write here", "remark": "no"}
]
